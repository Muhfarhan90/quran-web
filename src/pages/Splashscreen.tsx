...
function Splashscreen() {
  return (
    <div className="relative min-h-screen container mx-auto bg-[url('./assets/Splashscreen.png')] bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center my-auto">
